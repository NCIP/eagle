...
<html:form action="chromosomeBrowser.do?method=submit" onsubmit="return CCForm.validate('enter'); " styleId="ccForm">
				...
				<tr style="vertical-align: top;">
					<td>
						...
						<span style="display:none; width:1px; height:1px; overflow:none;" id="optionsContainer">
							...
							<logic:iterate id="chromosomeBrowserForm" name="chromosomeBrowserForm" property="existingGroups" scope="request">
								<option value="<bean:write name="chromosomeBrowserForm" property="value"/>"><bean:write name="chromosomeBrowserForm" property="value"/></option>
							</logic:iterate>
							</select>
							
							<select id="tissueGroupsOptions">
							<logic:iterate id="chromosomeBrowserForm" name="chromosomeBrowserForm" property="existingTissueGroups" scope="request">
								<option value="<bean:write name="chromosomeBrowserForm" property="value"/>"><bean:write name="chromosomeBrowserForm" property="value"/></option>
							</logic:iterate>
							</select>
