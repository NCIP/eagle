...
ChromosomeBrowser = Class.create();
Object.extend(ChromosomeBrowser.prototype, {
	div:"chromosomeBrowser", 
	chromosome:null, 
	arms: null,
	bands:null,
	initialize:function (chromosome, arms, bands) {
	...
	drawBands:function (cytobands) {
		...
		for (var index = 0; index < cytobands.length; ++index) {
			...
			this.drawBand(rec, cytobands[index].name, shade);
			shade = !shade;
	...
	/*
dojo.widget.defineWidget("user.ChromosomeBrowser", dojo.widget.HtmlWidget, {render:function () {
